...
def upload_ambos():
    ...
    _rodar_spo(arquivos, "spo_ln",              processar_ln,                    resultados, _mes_ref, msg="+LN processado")
    ...
    for campo in ORDEM:
        ...
        try:
            if campo == "clientes":
                ...
                processar_ln(b, mes_ref=mes_ref)
            elif campo == "spo_ap":
